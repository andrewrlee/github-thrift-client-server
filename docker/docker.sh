...
function start {
  ...
  sudo docker run --name feeder_01       -d --link mongodb_01:mongodb plasma147/feeder
}
...
function stop {
  sudo docker stop  thriftserver_01 feeder_01 mongodb_01
  sudo docker rm    thriftserver_01 feeder_01 mongodb_01
}
